---
description: Game UI Studio 프리팹 YAML 정규화 규칙 참조. runtime/normalize-prefab.mjs의 정규화 로직을 설명합니다. $ARGUMENTS로 특정 규칙을 조회할 수 있습니다.
---
...
- `ManagedMarker` 컴포넌트의 `stableKey` 필드를 정규화 키로 사용합니다.
