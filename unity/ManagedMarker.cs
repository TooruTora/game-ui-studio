// Game UI Studio — 파이프라인 관리 마커 컴포넌트
//
// 이 .cs는 "사용자 View/로직 코드"가 아니다. 파이프라인이 사용자 Unity 프로젝트
// Assets/GameUiStudio/ 아래로 동기화하는 고정 부품이다 (P2 정밀화: "사용자 View/로직
...
// CONTRACT.md (i): manifest.element.key === ManagedMarker.stableKey.

using System;
using UnityEngine;

namespace GameUiStudio
{
    /// <summary>
    ...
    public sealed class ManagedMarker : MonoBehaviour
    {
